...
<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center gap-3">
      ...
      <div>
        <h3 class="font-semibold">Statut PWA</h3>
        <p class="text-sm text-muted-foreground">État actuel de l'application</p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div class="flex items-center justify-between p-3 rounded-lg border">
        <div class="flex items-center gap-3">
          ...
          <span class="font-medium">Mode App</span>
        </div>
      ...
      <div class="flex items-center justify-between p-3 rounded-lg border">
        <div class="flex items-center gap-3">
          ...
          <span class="font-medium">Mises à jour</span>
        </div>
    ...
    <!-- Features Section -->
    <div>
      <h4 class="font-medium mb-3">Fonctionnalités</h4>
    ...
    <div class="flex flex-col sm:flex-row gap-3">
      ...
      <div v-if="installStatus.label.includes('iOS')"
        ...
        <p class="font-medium text-blue-800 mb-1">Ajouter à l'écran d'accueil</p>
