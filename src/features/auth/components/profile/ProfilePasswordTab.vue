...
const onSubmit = async (event: Event) => {
  ...
  try {
    ...
    try {
      ...
      toastService.success('Mot de passe changé', 'Votre mot de passe a été changé avec succès');
      ...
      error.value = apiError.response?.data?.message || 'Échec du changement de mot de passe';
