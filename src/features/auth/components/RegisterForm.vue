...
const handleRegister = async () => {
  ...
  try {
    ...
    error.value = apiError.response?.data?.message || 'Une erreur s\'est produite lors de la création de votre compte. Veuillez réessayer.'
...
<template>
  <Card class="w-full max-w-md mx-auto">
    <CardHeader>
      <CardTitle class="text-2xl font-bold text-center">Créer un compte</CardTitle>
      ...
      <form @submit.prevent="handleRegister" class="space-y-4">
        ...
        <div class="space-y-2">
          ...
          <p v-if="username && !isUsernameValid" class="text-sm text-red-500">
            Le nom d'utilisateur doit faire entre 3 et 20 caractères (lettres, chiffres et tirets bas autorisés)
          </p>
        </div>
        ...
        <div class="space-y-2">
          ...
          <p v-if="password && !isPasswordValid" class="text-sm text-red-500">
            Le mot de passe doit contenir au minimum 8 caractères avec des lettres et des chiffres
          </p>
        </div>
