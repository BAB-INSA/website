...
<template>
  <div class="space-y-6">
    <!-- Header -->
    <div>
      <h2 class="text-2xl font-bold">Galerie de Thèmes</h2>
      <p class="text-muted-foreground mt-1">Choisissez parmi notre collection de thèmes inspirés des jeux vidéo</p>
    </div>
