...
<template>
    <div class="container mx-auto max-w-4xl px-4 py-8 space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-bold">Paramètres PWA</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card>
                <CardContent class="pt-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-muted-foreground">Mode App</p>
            ...
            <Card>
                <CardContent class="pt-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-muted-foreground">Connexion</p>
                            <p class="text-2xl font-bold">{{ isOnline ? 'En ligne' : 'Hors ligne' }}</p>
                        </div>
            ...
            <Card>
                <CardContent class="pt-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-muted-foreground">Stockage utilisé</p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="flex items-center justify-between p-3 rounded-lg border">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="font-medium">Installation de l'app</span>
                                </div>
                                <Badge :variant="canInstall || isPWA ? 'default' : 'secondary'">
                                    {{ canInstall ? 'Disponible' : isPWA ? 'Installé' : 'Non disponible' }}
                                </Badge>
                            </div>
                            ...
                            <div class="flex items-center justify-between p-3 rounded-lg border">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="font-medium">Support hors ligne</span>
                                </div>
                            ...
                            <div class="flex items-center justify-between p-3 rounded-lg border">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="font-medium">Mises à jour automatiques</span>
                                </div>
                            ...
                            <div class="flex items-center justify-between p-3 rounded-lg border">
                                ...
                                <Badge variant="secondary">Futur</Badge>
                            </div>
                        </div>
                    </CardContent>
                </Card>
            ...
            <TabsContent value="installation" class="space-y-6">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Installez cette app sur votre appareil pour une expérience native
                        </CardDescription>
                    </CardHeader>
                    <CardContent class="space-y-4">
                        <div v-if="isPWA" class="p-4 bg-green-50 border border-green-200 rounded-lg">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 class="font-medium text-green-800">L'app est installée</h3>
                        ...
                        <div v-else-if="canInstall" class="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 class="font-medium text-blue-800">Prête à installer</h3>
                                        <p class="text-sm text-blue-600">
                                            Installez cette app pour un accès rapide et de meilleures performances
                                        </p>
                                    </div>
                                </div>
                                <Button
                        ...
                        <div v-else class="p-4 bg-gray-50 border border-gray-200 rounded-lg">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 class="font-medium text-gray-800">Installation non disponible</h3>
                        ...
                        <div>
                            <h4 class="font-medium mb-3">Avantages de l'installation</h4>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <div class="flex items-center gap-2 text-sm">
                                    <div class="w-2 h-2 bg-green-500 rounded-full"></div>
                                    <span>Temps de chargement plus rapides</span>
                                </div>
                                <div class="flex items-center gap-2 text-sm">
                                    <div class="w-2 h-2 bg-green-500 rounded-full"></div>
            ...
            <TabsContent value="storage" class="space-y-6">
                <Card>
                    ...
                    <CardContent class="space-y-4">
                        ...
                        <div>
                            <h4 class="font-medium mb-3">Catégories de stockage</h4>
                            <div class="space-y-2">
            ...
            <TabsContent value="offline" class="space-y-6">
                <Card>
                    ...
                    <CardContent class="space-y-4">
                        ...
                        <div>
                            <h4 class="font-medium mb-3">Disponible hors ligne</h4>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <div class="flex items-center gap-2 text-sm">
                                    <div class="w-2 h-2 bg-green-500 rounded-full"></div>
                            ...
                            <div v-if="updateAvailable" class="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h3 class="font-medium text-blue-800">Mise à jour disponible</h3>
                                            <p class="text-sm text-blue-600">
